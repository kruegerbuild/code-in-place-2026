...
'''
Draw the circles such that all parts 
of the circle are within the canvas 
'''
...
def draw_random_circles(canvas):
    random_x = random.randint(0, CANVAS_WIDTH - 20)
    random_y = random.randint(0, CANVAS_HEIGHT - 20)
    canvas.create_oval(
        random_x, 
        random_y, 
